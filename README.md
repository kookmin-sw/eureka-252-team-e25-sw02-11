...
반중력 장치, 디지털 바이오 시대, 스마트 인프라 등 도시 전체가 기술로 유기적으로 연결된 미래를 상상한 팀.

공중에 떠 있는 도시 구조, 자율주행 교통 시스템, 개인 맞춤형 생활 공간 등 시각 자료의 완성도가 높았음.

단순히 미래의 건축과 기술을 나열한 것이 아니라, 개인의 생활 방식과 주거 환경 변화까지 통찰한 점이 인상적이었음.

팀원 개개인의 의견을 따로 정리한 구성 방식이 독창적이었음.

4조: 2040·2050년대의 미래

자기 복제 기술, 신경 연결 구조 기록, 뇌 업로드, 수면 단축 기술, 인간 수명 연장 등 인간의 존재 자체를 재정의하는 기술들을 제시함.

뇌 업로드를 통해 죽음을 정보의 이식으로 바라보는 관점은 현실에서도 논의되는 주제로 몰입도가 높았음.

기술적 설명뿐 아니라 윤리적 문제까지 함께 고려한 점이 깊이 있는 전시로 느껴졌음.

참가 소감

이번 전시를 통해 기술 발전을 바라볼 때 편리함과 효율성뿐 아니라 인간다움, 사회적 의미, 윤리적 기준까지 함께 고려해야 한다는 점을 다시 느끼게 되었음.

미래 기술은 우리의 삶을 크게 변화시키겠지만, 이를 어떤 방향으로 활용하고 조정할지는 결국 인간 중심의 판단이 핵심적임을 깨달았음.
