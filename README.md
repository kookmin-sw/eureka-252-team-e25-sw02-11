...
| **이름** | **전공** | **관심사** |
| --- | --- | --- |
| **위명준** | 소프트웨어전공 | 인공지능, 프론트엔드 |
| **최우혁** | 소프트웨어전공 | 알고리즘, 계산기하 |
...
# 3주차 활동 : 과거 사람들이 생각한 미래
  - 1995년에 그려진 내용을 보면서 현재 가능한 기술이 무엇인지 살펴보고 논의하기
   <img width="547" height="756" alt="image" src="https://github.com/user-attachments/assets/0633832c-de96-4e50-b0d3-6318ea50221f" />
...
- 최우혁: 나의 지도교수님 함께 만나기/ 작은 단위의 문제해결을 넘어 프로젝트 단위의 설계를 하는 방법에 대해 질문을 하였고 오픈소스 프로젝트를 뜯어보며 공부하면 좋을 거라는 조언을 받아 방학 때 이를 실천해 보려 한다.

- 오태유: 우리가 상상한 미래/ 조원들과 토의할 때는 미래가 단순히 긍정적으로만 발전할 거라 생각했는데, 한국 개발 생태계의 갈라파고스화라는 관점을 접하며 다른 시각도 존재한다는 점이 인상 깊었다.
...
- 최우혁: 국내 알고리즘 관련 연구실, 혹은 SWE 취업 준비

- 오태유: 산학 협력 캡스톤 프로젝트와 인턴십을 통한 현장 경험 및 취업 연계 가능성
...
🔗20252364 최우혁 
> 개발과 연구 사이에서 고민하고 있었는데 유레카 프로젝트를 수강하며 조금 더 깊게 이를 생각해 볼 수 있었다. 추후 진로 설계 및 결정에 도움이 될 것 같아 좋았다.
