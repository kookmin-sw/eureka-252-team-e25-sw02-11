...
-엔드라 찬메이 (20252337)
-(지도교수 만나기)지도교수님을 만나 뵙고 프론트엔드에 관심이 있다고 말씀드렸을 때, 스스로 프로젝트를 해보는 것이 정말 중요하다는 조언을 포함해 여러 가지 핵심적인 내용을 알게 되어 큰 도움이 되었다고 느꼈다.
...
- 예: 졸업 후 진로(대학원/취업)
 -엔드라 찬메이 (20252337)
1️⃣ 게임 UI 디자인을 웹사이트 화면 디자인에 적용해 보기
2️⃣ 웹사이트에서 게임처럼 인터랙션이 있는 UI 만들기 연구
3️⃣ 초보자를 위한 웹 기반 미니 게임 UI 제작 과정 탐구
...
> 학번 - 20252337
> 이름 - 엔드라 찬메이
> 좋은 팀원들과 함께 관심 있는 분야에 대해 서로 의견을 나누고, 교수님과 소프트웨어·AI 분야 전문가들의 경험을 들으며 그 경험을 바탕으로 더 성장해 나갈 수 있기를 기대합니다.
